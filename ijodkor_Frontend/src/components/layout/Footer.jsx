    ...
    <footer className="bg-gray-900 text-gray-300 mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <img src="/logo-footer.png" alt="Yoshijodkor" className="w-10 h-10 object-contain"/>
              <div>
            ...
            <div className="flex gap-3 mt-4">
              {['📘','📷','▶️','✉️'].map((icon, i) => (
                <a key={i} href="#" className="w-9 h-9 bg-gray-800 hover:bg-[#1a56db] rounded-lg flex items-center justify-center text-base transition">
                  {icon}
                </a>
              ))}
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-sm">
                <MapPin size={15} className="text-[#f97316] flex-shrink-0 mt-0.5"/>
                <span>Qashqadaryo viloyati, Qarshi shahri, I.Karimov ko'chasi, 276-uy</span>
              </li>
              <li className="flex items-center gap-2 text-sm">
                <Phone size={15} className="text-[#f97316]"/>
                <a href="tel:+998987770727" className="hover:text-white transition">+998 98 777 07 27</a>
              </li>
              <li className="flex items-center gap-2 text-sm">
                <Mail size={15} className="text-[#f97316]"/>
                <a href="mailto:info@yoshijodkor.uz" className="hover:text-white transition">info@yoshijodkor.uz</a>
              </li>
              <li className="flex items-start gap-2 text-sm">
                <Send size={15} className="text-[#f97316] flex-shrink-0 mt-0.5"/>
          ...
          {/* Payment */}
          <div>
            <h4 className="text-white font-bold mb-4 text-sm uppercase tracking-wider">{t('paymentMethods')}</h4>
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <div key={p.name} className={`${p.color} text-white text-xs font-bold text-center py-2 px-3 rounded-lg`}>
                  {p.name}
                </div>
              ))}
            </div>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col sm:flex-row justify-between items-center gap-2 text-xs text-gray-500">
          <span>© 2025 Yoshijodkor.uz. {t('rights')}.</span>
